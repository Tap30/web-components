...
describe("🧩 notice", () => {
  ...
  test("🧪 should show slots correctly (`action` and `artwork`)", async ({
    ...
    <tapsi-notice
      ...
      visible
    >
      <svg data-testid="test-notice-artwork-slot" slot="artwork" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <tapsi-button data-testid="test-notice-action-slot" slot="action">اکشن ۱</tapsi-button>
      <tapsi-button data-testid="test-notice-action-slot" slot="action">اکشن ۲</tapsi-button>
    </tapsi-notice>
    `,
    );
