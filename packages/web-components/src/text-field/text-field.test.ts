  ...
  test("🧪 should render slots", async ({ page }) => {
    await render(
      ...
      <tapsi-text-field label="label" data-testid="test-text-field">
        <svg data-testid="leading-icon" slot=${Slots.LEADING_ICON} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <tapsi-button data-testid="trailing" slot=${Slots.TRAILING}>click</tapsi-button>
      </tapsi-text-field>
      `,
    );
