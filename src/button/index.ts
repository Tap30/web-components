 ...
 *
 * @cssprop `--tap-font-family` - The font family for the button.
 * @cssprop `--tap-sys-radius-full` - The border radius for the button.
 * @cssprop `--tap-button-color-surface-cover` - The surface cover color for the button.
 ...
 * @cssprop `--tap-button-color-surface-disabled` - The disabled surface color for the button.
 ...
 * @cssprop `--tap-button-typography-label-sm-height` - The line height for the small button label.
 * @cssprop `--tap-button-typography-label-sm-size` - The font size for the small button label.
 * @cssprop `--tap-button-typography-label-sm-weight` - The font weight for the small button label.
 * @cssprop `--tap-button-typography-label-md-height` - The line height for the medium button label.
 * @cssprop `--tap-button-typography-label-md-size` - The font size for the medium button label.
 * @cssprop `--tap-button-typography-label-md-weight` - The font weight for the medium button label.
 * @cssprop `--tap-button-typography-label-lg-height` - The line height for the large button label.
 * @cssprop `--tap-button-typography-label-lg-size` - The font size for the large button label.
 * @cssprop `--tap-button-typography-label-lg-weight` - The font weight for the large button label.
 * @cssprop `--tap-button-color-surface-inverse-primary` - The surface color for the primary variant.
 * @cssprop `--tap-sys-color-surface-inverse-primary` - The surface color for the primary variant.
 * @cssprop `--tap-button-color-content-on-inverse` - The content color on inverse surface.
 * @cssprop `--tap-sys-color-content-on-inverse` - The content color on inverse surface.
 * @cssprop `--tap-button-color-surface-tertiary` - The surface color for the ghost variant.
 * @cssprop `--tap-sys-color-surface-tertiary` - The surface color for the ghost variant.
 * @cssprop `--tap-button-color-content-primary` - The content color for the primary variant.
 * @cssprop `--tap-sys-color-content-primary` - The content color for the primary variant.
 * @cssprop `--tap-button-color-surface-primary` - The surface color for the elevated variant.
 * @cssprop `--tap-sys-color-surface-primary` - The surface color for the elevated variant.
 * @cssprop `--tap-button-color-surface-destructive` - The surface color for the destructive variant.
 * @cssprop `--tap-sys-color-surface-negative-light` - The surface color for the destructive variant.
 * @cssprop `--tap-button-color-content-destructive` - The content color for the destructive variant.
 * @cssprop `--tap-sys-color-content-negative` - The content color for the destructive variant.
 * @cssprop `--tap-button-color-gradient-brand` - The gradient color for the brand variant.
