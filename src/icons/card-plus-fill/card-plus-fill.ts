  ...
  render() {
    return this.renderIcon(html`
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path fill-rule="evenodd" clip-rule="evenodd" d="M22 11H2V18L2.00549 18.1493C2.08183 19.1841 2.94564 20 4 20H18V18H15V16H18V13H20V16H22V11ZM20 18H22C22 19.0544 21.1841 19.9182 20.1493 19.9945L20 20V18ZM5.99512 14H10.0166V16H5.99512V14Z" fill="currentColor"/>
