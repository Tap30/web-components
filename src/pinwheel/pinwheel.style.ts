...
export default css`
  ...
  .pinwheel > div {
    ...
    padding: var(--tap-pinwheel-vertical-padding, var(--tap-sys-spacing-0)) var(--tap-pinwheel-horizontal-padding, var(--tap-sys-spacing-6));
    /* FIXME: we dont have sizing tokens yet  */
    ...
    color: var(--tap-pinwheel-item-color, var(--tap-sys-color-content-tertiary));
  }
  ...
  .pinwheel .active {
    ...
    color: var(--tap-pinwheel-active-item-color, var(--tap-sys-color-content-primary));
  }
`;
